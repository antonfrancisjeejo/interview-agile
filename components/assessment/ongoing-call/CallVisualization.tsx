...
interface CallVisualizationProps {
  speakingParticipant?: boolean;
}

export function CallVisualization({
  speakingParticipant = false,
  ...
  return (
    <div className="h-20 sm:h-40 flex items-center justify-center my-2 sm:my-0">
      <div
        className={`${
          size.outer
        } rounded-full bg-gradient-to-br from-blue-400/20 to-purple-400/20 dark:from-blue-500/10 dark:to-purple-500/10 flex items-center justify-center ${
          speakingParticipant ? "animate-pulse" : ""
        }`}
      >
        <div
